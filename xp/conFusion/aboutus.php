...
Australian outback gave him great appreciation for varieties of food 
                    sources. As he puts it in his own words, <em>Everything that runs, wins, and everything that stays, pays!</em></p>          </div>
                        </div>
                    </div>
                </div>
...
culinary world, he specializes in creating mouthwatering Indo-Italian 
    ...
    <script src="aboutus_fichiers/jquery.js"></script>
    <script src="js/jquery.js"></script>
    <!-- Include all compiled plugins (below), or include individual files as needed -->
    <script src="aboutus_fichiers/bootstrap_002.xml"></script>
